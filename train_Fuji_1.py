...
filepath="F:\\Learning-to-See-in-the-Dark\\checkpoints_1\\model-{epoch:02d}-{val_acc:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=False, mode='max', period = 50) #treba promeniti pre pokretanja!!! 
callbacks_list.append(checkpoint)

history = model_net.fit(input_patch_list[:, :, :, :], gt_patch_list[:, :, :, :], validation_split=0.2, epochs = 10000, batch_size = 16, callbacks=callbacks_list)
#!!!!
models.save_model(model_net, 'my_model_08_11.h5')
